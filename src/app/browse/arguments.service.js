	  ...
	  return {
		refreshArgs: function() {
			args = {
				...
				rulesFilter: {
					label: (($route.current.params.ruleslabelfilter)
							? $route.current.params.ruleslabelfilter
							: status.rulesFilter.label),
					kinds: (($route.current.params.ruleskindfilter)
							? $route.current.params.ruleskindfilter
							: status.rulesFilter.kinds)
				}
			};
