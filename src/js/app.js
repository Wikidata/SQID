	...
	.config(['$translateProvider', function ($translateProvider) {
		...
		var enMessages = {
			...
			NO_SUBPROPERTY_OF_PHRASE: '{{entity}} is not a subproperty of any other property',
		 	SEC_CLASSIFICATION : {
				...
				INSTANCE_SUBCLASSES: 'Subclasses with instances',
				...
				SUBCLASS_SUBCLASSES: 'Subclasses with subclasses',
		...
		var deMessages = {
			...
			SEC_CLASSIFICATION : {
				...
				INSTANCE_SUBCLASSES: 'Unterklassen mit Instanzen',
				INSTANCE_SUBCLASSES_HINT: 'Direkte Unterklassen, welche eigene Instanzen haben, sowie die Gesamtzahl ihrer direkten und indirekten Instanzen',
				SUBCLASS_SUBCLASSES: 'Unterklassen mit Unterklassen',
				SUBCLASS_SUBCLASSES_HINT: 'Direkte Unterklassen, welche eigene Unterklassen haben, sowie die Gesamtzahl ihrer direkten und indirekten Unterklassen',
			},
			SEC_INSTANCES : {
